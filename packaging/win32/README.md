...
.\build.ps1 -Name icons-streamline-vectors -Version 1.2.3
```
...
```
<project>/.config/icons-streamline-vectors/<packaging>.build-host
$HOME/.config/icons-streamline-vectors/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-streamline-vectors
```
